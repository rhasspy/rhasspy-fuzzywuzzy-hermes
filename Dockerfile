# -----------------------------------------------------------------------------
# Dockerfile for Rhasspy Fuzzywuzzy Service
# (https://github.com/rhasspy/rhasspy-fuzzywuzzy-hermes)
#
...
ENV APP_DIR=/usr/lib/rhasspy-fuzzywuzzy-hermes
ENV BUILD_DIR=/build
...
# Copy source
COPY rhasspyfuzzywuzzy_hermes/ ${APP_DIR}/rhasspyfuzzywuzzy_hermes/
COPY bin/rhasspy-fuzzywuzzy-hermes ${APP_DIR}/bin/

ENTRYPOINT ["bash", "/usr/lib/rhasspy-fuzzywuzzy-hermes/bin/rhasspy-fuzzywuzzy-hermes"]
